...
public:
	...
	int PrintTscWhite(char* printerName,const string& printStr,LONG nPrintType);
	bool printNewWhite_tsc(const string& printStr,int X, int Y,fTSC_Sendcommand TSC_DrawQR,fTSC_Windowsfont TSC_DrawText);
};
